...
const EXPENSE_TYPES = ['freight', 'duty', 'handling', 'loading', 'unloading', 'insurance', 'other']
const GST_RATES     = [0, 5, 12, 18, 28]

const EMPTY = {
  expense_date: today(), entity_id: '', expense_type: 'freight',
...
export default function Expenses() {
  ...
  const filtered = expenses.filter(e => {
    ...
    const mt = typeFilter === 'all' || e.expense_type === typeFilter
    return ms && mt
  })
  ...
  const columns = [
    ...
    { label: 'Docs',     render: e => <DocumentAttachments sourceType='expenses' sourceId={e.id} entityName={e.entity?.name || 'General'} compact /> },
  ]
