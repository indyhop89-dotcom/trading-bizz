  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: '20px', marginBottom: '20px', flexWrap: 'wrap', fontSize: '13px' }}>
        ...
        <div><span style={{ color: C.textMuted }}>Tax:</span> <Badge status={note.is_interstate ? 'export' : 'domestic'} label={note.is_interstate ? 'IGST' : 'CGST+SGST'} /></div>
      </div>
      ...
      <div style={{ marginBottom: '16px' }}>
        ...
        <DocumentAttachments sourceType='credit_debit_notes' sourceId={note.id} entityName={note.issuer?.name || 'General'} />
      </div>
